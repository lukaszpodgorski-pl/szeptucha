; Custom NSIS template for Szeptucha with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Szeptucha for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older Szeptucha releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Szeptucha Portable Mode"
    FileClose $0
