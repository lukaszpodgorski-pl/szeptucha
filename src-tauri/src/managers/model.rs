...
/// Base URL for downloading speech-to-text models.
///
/// Point this at your own server. Every model file referenced below must be
/// hosted under this URL using the same filenames. This is the single place
/// to change the model download source.
pub const MODEL_BASE_URL: &str = "https://www.aitomate.pl/models";
    ...
    pub fn new(app_handle: &AppHandle) -> Result<Self> {
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(format!("{}/ggml-small.bin", MODEL_BASE_URL)),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(format!("{}/whisper-medium-q4_1.bin", MODEL_BASE_URL)),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(format!("{}/ggml-large-v3-turbo.bin", MODEL_BASE_URL)),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(format!("{}/ggml-large-v3-q5_0.bin", MODEL_BASE_URL)),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(format!("{}/breeze-asr-q5_k.bin", MODEL_BASE_URL)),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(format!("{}/parakeet-v2-int8.tar.gz", MODEL_BASE_URL)),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(format!("{}/parakeet-v3-int8.tar.bin", MODEL_BASE_URL)),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(format!("{}/moonshine-base.tar.gz", MODEL_BASE_URL)),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(format!("{}/sense-voice-int8.tar.gz", MODEL_BASE_URL)),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(format!("{}/giga-am-v3-int8.tar.gz", MODEL_BASE_URL)),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(format!("{}/canary-180m-flash.tar.gz", MODEL_BASE_URL)),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(format!("{}/canary-1b-v2.tar.gz", MODEL_BASE_URL)),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(format!("{}/cohere-int8.tar.gz", MODEL_BASE_URL)),
                sha256: Some(
