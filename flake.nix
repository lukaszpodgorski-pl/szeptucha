{
  description = "Szeptucha - A free, open source, and extensible speech-to-text application that works completely offline";
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "Szeptucha development environment"
              bun install
