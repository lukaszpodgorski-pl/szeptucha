...
This guide covers how to set up the development environment and build Szeptucha from source across different platforms.
...
```bash
git clone <your-repository-url> szeptucha
cd szeptucha
```
...
```
Bundling Szeptucha_*_amd64.AppImage
...
~/.cache/tauri/linuxdeploy-x86_64.AppImage --appimage-extract-and-run \
  --appdir Szeptucha.AppDir --plugin gtk --output appimage
```
